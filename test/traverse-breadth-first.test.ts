...
describe("Projection", () => {
  test("traverseBreadthFirst", function () {
    const values = Enumerable.make(1)
      .traverseBreadthFirst(value => Enumerable.make(value + value))
      .take(7)
      .toArray();
...
test('traverseBreadthFirst reports zero-based levels', () => {
...
test('traverseBreadthFirst handles an empty root sequence', () => {
